        ...
        switch (view.getId()) {
            case R.id.l_w_e_old_contract:
                showDialog("", "确定要执行原合同吗？", "执行原合同", "取消", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (TextUtils.equals(tag, "cap")) {
                            contract.capCancelContractOpinion(contract_noid, noid, LookWorkerEditFgt.this);
                        } else {
                            contract.labCancelContractOpinion(contract_noid, noid, LookWorkerEditFgt.this);
                        }
                    }
                }, null);
                break;
            ...
            case R.id.l_w_e_agree_contract:
                showDialog("", "确定同意对方对合同的修改吗？", "同意", "取消", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (TextUtils.equals(tag, "cap")) {
                            contract.capAcceptContractOpinion(contract_noid, noid, LookWorkerEditFgt.this);
                        } else {
                            contract.labAcceptContractOpinion(contract_noid, noid, LookWorkerEditFgt.this);
                        }
                    }
                }, null);
                break;
